<template>
    <div class="ringChart">
        <div ref="ringChart" id="ringChart1"></div>
        <div ref="ringChart" id="ringChart2"></div>
        <div ref="ringChart" id="ringChart3"></div>
        <div ref="ringChart" id="ringChart4"></div>
        <div ref="ringChart" id="ringChart5"></div>
        <div ref="ringChart" id="ringChart6"></div>
    </div>
</template>
